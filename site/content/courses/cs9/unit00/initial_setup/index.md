...
{{< figure src="images/courses/cs9/unit00/-000_initialsetup12.gif" width="50%" alt-text="mwc setup" >}}
...
{{< figure src="images/courses/cs9/unit00/-000_initialsetup7.png" width="100%" alt-text="mwc setup" >}}

In the prompt, type `Shell Commands` and click on the first option to install the `code` command in your PATH.

{{< figure src="images/courses/cs9/unit00/-000_initialsetup6.png" width="100%" alt-text="mwc setup" >}}
...
{{< figure src="images/courses/cs9/unit00/-000_initialsetup9.png" width="100%" alt-text="mwc setup" >}}
- Or, you can find it using your computer's `launchpad`
{{< figure src="images/courses/cs9/unit00/-000_initialsetup11.png" height="50%" alt-text="mwc setup" >}}


One you have it open, it should look something like this:
{{< figure src="images/courses/cs9/unit00/-000_initialsetup10.png" width="100%" alt-text="mwc setup" >}}
